...
[Agent Skills](https://agentskills.io/) 공개 규격을 따르는 한국어 작성 및 교정 스킬입니다.
영어를 직역했거나 문체가 고르지 못한 기술 문서, PR 본문, UI 문구를 한국어 원어민이 읽었을
때 자연스럽고 매끄러운 문장으로 다듬습니다. Codex와 Claude Code를 비롯한 Agent Skills 호환
에이전트에서 사용할 수 있습니다. OpenRouter를 통해 Gemini가 초고를 작성하고, 내장된 문체
규약을 바탕으로 기계적인 번역투와 불필요한 대명사, 어미 혼용을 정리합니다. 확인되지 않은
사실이나 출처를 보태지 않고 과장, 홍보 문구, 틀에 박힌 결론 같은 AI 글쓰기 패턴도 억제합니다.
